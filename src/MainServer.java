...
public class MainServer {
	...
	@OnOpen
	synchronized public void open(Session session) {
		System.out.println("Client connected");
	}

	@OnMessage
	synchronized public void onMessage(String userId, Session session) {
	...
	@OnClose
	synchronized public void close(Session session) {
