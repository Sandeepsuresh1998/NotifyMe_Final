...
<meta name="google-signin-client_id" content="496920584851-fmjavghisqpvdb9i0s0cs08q5fuvo63u.apps.googleusercontent.com">
</head>
<body>
<!--
...
<script>
	function onSignIn(googleUser) {
		...
		xhr.open('POST', 'http://localhost:8080/NotifyMe_Final/LoginServlet', true);
	 ...
	 var YOUR_CLIENT_ID = '496920584851-fmjavghisqpvdb9i0s0cs08q5fuvo63u.apps.googleusercontent.com';
	  var YOUR_REDIRECT_URI = 'http://localhost:8080/NotifyMe_Final/Index.jsp';
